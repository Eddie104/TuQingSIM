module libra.aStar {
    ...
    export class Grid {
        ...
        * @param col 列
        */
        public getNode(row: number, col: number): NodePoint {
        ...
        */
        public setEndNode(row: number, col: number): void {
            this._endNode = this._nodes[row][col];
        }
        ...
        */
        public hasBarrier(startX: number, startY: number, endX: number, endY: number): boolean {
            ...
            if (loopDirection) {
                lineFuction = libra.utils.MathUtil.getLineFunc(point1, point2, 0);
                ...
                lineFuction = libra.utils.MathUtil.getLineFunc(point1, point2, 1);
